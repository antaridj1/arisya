            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <a href="" class="btn btn-primary" data-toggle="modal" data-target="#edit_{{$user->id}}">
                    ...
                    <a href="{{route('editpass',$user->id)}}" class="btn btn-primary" data-toggle="modal" data-target="#edit_pass_{{$user->id}}">
                            Ubah Password
                        </a>
